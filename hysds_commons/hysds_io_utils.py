...
def get_hysds_ios(es_url, logger=None, hysds_io_type=HYSDS_IO_TYPE):
    '''
...
def get_hysds_io(es_url, ident, logger=None, hysds_io_type=HYSDS_IO_TYPE):
    '''
...
def add_hysds_io(es_url, obj, logger=None, hysds_io_type=HYSDS_IO_TYPE):
    '''
...
def remove_hysds_io(es_url, ident, logger=None, hysds_io_type=HYSDS_IO_TYPE):
    '''
    Remove a container
    @param es_url - elastic search URL (from owning app i.e. Mozart, Tosca)
